...
| :--- | :--- | :--- |
| **Frontend/Mobile** | HTML, CSS, JavaScript, **Flutter** | React.js, Next.js |
| **Backend/Database** | Node.js, Express, **MySQL** | GoLang, PostgreSQL |
| **DevOps/Tools** | Git, Docker, Linux | Kubernetes, CI/CD |
